...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  KC_GRV, KC_BSLASH, KC_LALT, KC_LGUI, LOWER,     KC_SPC, KC_SPC,    RAISE, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
  ...
  LSFT(KC_GRV),   LSFT(KC_BSLASH), _______, _______, _______,     _______,      _______, _______, _______, _______, _______, _______
),
